            ...
            <div class="mt-1 container">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        ...
                        <a class="nav-link active" href="http://localhost/PFC_PHP/?pagina=Anotacoes">Home</span></a>
                        <a class="nav-link" href="http://localhost/PFC_PHP/?pagina=anotacoes&metodo=formularioCadastrarAnotacao">Criar anotação</a>
                        <a class="nav-link" href="http://localhost/PFC_PHP/?pagina=anotacoes&metodo=deslogar">Sair</a>
                        </div>
                    </div>
                </nav>
